...
if ( ! class_exists( 'Creative_Portfolio_Lite_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Creative_Portfolio_Lite_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Creative_Portfolio_Lite_WPTT_WebFont_Loader( $url );
