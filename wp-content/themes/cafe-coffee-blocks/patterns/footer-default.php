...
return array(
    ...
    <div class="wp-block-group has-background-color has-text-color has-background has-link-color" style="background-color:var(--wp--preset--color--thirdaccent)"><!-- wp:columns {"className":"alignwide","style":{"spacing":{"padding":{"top":"35px","bottom":"35px","right":"0px","left":"0px"},"blockGap":{"top":"0","left":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('About Us','cafe-coffee-blocks') .'</h2>
        <!-- /wp:heading -->
        
        <!-- wp:paragraph {"fontSize":"medium","fontFamily":"inter"} -->
        <p class="has-lato-font-family has-medium-font-size">'. esc_html__('Lorem Ipsum is simply dummy text of the printing and typesetting industry.','cafe-coffee-blocks') .'</p>
        <!-- /wp:paragraph -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('Menu','cafe-coffee-blocks') .'</h2>
        <!-- /wp:heading -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('Blog','cafe-coffee-blocks') .'</h2>
        <!-- /wp:heading -->
        ...
        <h2 class="wp-block-heading has-background-color has-text-color has-lato-font-family" style="font-size:22px;font-style:normal;font-weight:600">'. esc_html__('Contact Us','cafe-coffee-blocks') .'</h2>
        <!-- /wp:heading -->
        ...
        <p class="has-text-align-left has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family" style="font-style:normal;font-weight:400"><span class="dashicons dashicons-email-alt"></span><a href="mailto:info@example.com"> '. esc_html__('info@example.com','cafe-coffee-blocks') .'</a></p>
        <!-- /wp:paragraph -->
        ...
        <p class="has-link-color has-inter-font-family has-background-color has-text-color has-lato-font-family has-medium-font-size" style="font-style:normal;font-weight:500"><span class="dashicons dashicons-phone"></span><a href="tel:+1 (143) 456-7897"> '. esc_html__('+1 (143) 456-7897','cafe-coffee-blocks') .'</a></p>
        <!-- /wp:paragraph -->
        ...
        <p class="has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family" style="font-style:normal;font-weight:500"><span class="dashicons dashicons-admin-home"></span> <a href="#">'. esc_html__('123 Glassford Street New York, USA','cafe-coffee-blocks') .'</a></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div>
        <!-- /wp:group -->
        ...
        <p class="has-text-align-center has-background-color has-text-color has-link-color has-inter-font-family has-medium-font-size has-lato-font-family"><a href="https://www.wpradiant.net/products/free-coffee-wordpress-theme">'. esc_html__('Coffee WordPress Theme ','cafe-coffee-blocks') .'</a> By <a href="https://www.wpradiant.net/">'. esc_html__('WP Radiant','cafe-coffee-blocks') .'</a> |'. esc_html__('Proudly powered by','cafe-coffee-blocks') .' <a href="https://wordpress.org/">  '. esc_html__('WordPress','cafe-coffee-blocks') .'</a></p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div>
        <!-- /wp:group -->
